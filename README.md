...
The 0.1.22 desktop build is validated on Windows 10/11 x64. Microsoft Edge WebView2 is normally already present on supported Windows installations.
...
Prime Orbit is an early desktop release. Version 0.1.22 ships Windows x64 NSIS and MSI installers through the signed stable update channel introduced in 0.1.14. macOS and Linux code paths exist, but official binaries have not yet been validated or published.
